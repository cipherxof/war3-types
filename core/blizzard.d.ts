...
declare function PlayDialogueFromSpeaker(toForce: force, speaker: unit, soundHandle: sound, timeType: number, timeVal: number, wait: boolean): void;
...
declare function PlayDialogueFromSpeakerType(toForce: force, fromPlayer: player, speakerType: number, loc: location, soundHandle: sound, timeType: number, timeVal: number, wait: boolean): boolean;
